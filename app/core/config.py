...
class Settings(BaseSettings):
    ...
    openai_model: str = Field(default="dengcao/Qwen3-Embedding-8B:Q5_K_M", description="嵌入模型")
    openai_dimensions: int = Field(default=4096, description="嵌入向量维度")
    openai_batch_size: int = Field(default=20, description="批处理大小")
