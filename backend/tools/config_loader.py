...
class ToolsConfigLoader:
    ...
    @classmethod
    def load_config(cls, environment: Optional[str] = None, force_reload: bool = False) -> str:
        """
        加载分层配置文件
...
def load_tools_config(environment: Optional[str] = None, force_reload: bool = False) -> str:
    """
    便捷函数：加载工具模块配置
