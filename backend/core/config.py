...
class Settings(BaseSettings):
    ...
    reranker_openai_base_url: str | None = Field(
        default=None,
        description="OpenAI重排序服务基础URL (如不设置则使用 openai_base_url)",
    )
    reranker_openai_api_key: str | None = Field(
        default=None,
    ...
    # Redis配置 (可选)
    redis_url: str | None = Field(default="redis://localhost:6379", description="Redis连接URL")
