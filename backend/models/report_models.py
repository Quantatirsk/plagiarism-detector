...
class GeneratedReport(BaseModel):
    ...
    data: Union[DocumentReportData, ComparisonReportData, ProjectReportData] = Field(..., description="报告数据")
...
class ReportGenerationRequest(BaseModel):
    ...
    # 文档报告参数
    document_id: Optional[str] = Field(None, description="文档ID (文档报告)")

    # 对比报告参数
    document_a_id: Optional[str] = Field(None, description="文档A ID (对比报告)")
    document_b_id: Optional[str] = Field(None, description="文档B ID (对比报告)")

    # 项目报告参数
    project_id: Optional[str] = Field(None, description="项目ID (项目报告)")
